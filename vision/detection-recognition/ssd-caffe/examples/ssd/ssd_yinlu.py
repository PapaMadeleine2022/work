...
import os
import sys
# add ssd-caffe/python to the PYTHONPATH
current_path=os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, os.path.dirname(os.path.dirname(current_path))+'/python')
...
output_result_dir = "{}/results/{}/{}/Main".format(data_root, dataset_name, job_name)
...
name_size_file = "data/{}/test_name_size.txt".format(dataset_name)
